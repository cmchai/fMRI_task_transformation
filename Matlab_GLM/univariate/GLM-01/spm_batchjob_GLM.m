%-----------------------------------------------------------------------
% Job saved on 22-Jun-2023 16:14:00 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.fmri_spec.dir = {'/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/bids/derivatives/1st_level/sub-003'};
...
%% run-1 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name = 'leftkey';
...
%% run-1 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).name = 'rightkey';
...
%% run-2 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(3).name = 'leftkey';
...
%% run-2 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(4).name = 'rightkey';
...
%% run-3 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(1).name = 'cue';
...
%% run-3 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(3).name = 'leftkey';
...
%% run-3 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(4).name = 'rightkey';
...
%% run-4 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(1).name = 'cue';
...
%% run-4 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(3).name = 'leftkey';
...
%% run-4 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(4).name = 'rightkey';
...
%% run-5 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(5).cond(1).name = 'cue';
...
%% run-5 condition-2
matlabbatch{1}.spm.stats.fmri_spec.sess(5).cond(2).name = 'stim';
...
%% run-5 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(5).cond(3).name = 'leftkey';
...
%% run-5 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(5).cond(4).name = 'rightkey';
...
%% run-6 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(6).cond(1).name = 'cue';
...
%% run-6 condition-2
matlabbatch{1}.spm.stats.fmri_spec.sess(6).cond(2).name = 'stim';
...
%% run-6 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(6).cond(3).name = 'leftkey';
...
%% run-6 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(6).cond(4).name = 'rightkey';
...
%% run-7 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(1).name = 'cue';
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(1).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(1).duration = 0;
...
%% run-7 condition-2
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(2).name = 'stim';
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(2).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(2).duration = 0;
...
%% run-7 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(3).name = 'leftkey';
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(3).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(3).duration = 0;
...
%% run-7 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(4).name = 'rightkey';
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(4).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(7).cond(4).duration = 0;
...
%% run-8 condition-1
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(1).name = 'cue';
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(1).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(1).duration = 0;
...
%% run-8 condition-2
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(2).name = 'stim';
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(2).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(2).duration = 0;
...
%% run-8 condition-3
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(3).name = 'leftkey';
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(3).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(3).duration = 0;
...
%% run-8 condition-4
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(4).name = 'rightkey';
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(4).onset = [];
matlabbatch{1}.spm.stats.fmri_spec.sess(8).cond(4).duration = 0;
