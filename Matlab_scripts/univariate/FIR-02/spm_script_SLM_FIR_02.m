...
jobfile_dir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_scripts/Matlab_GLM/univariate/FIR-02';
FLM_rootdir = '/Volumes/extdrive/Task_Transform_GLM/FIR-02/results';
output_dir  = '/Volumes/extdrive/Task_Transform_SLM/FIR-02/results';
...
jobfile = {fullfile(jobfile_dir, 'spm_batchjob_SLM_FIR_02.m')};  % Attention: the format should be a cell array
