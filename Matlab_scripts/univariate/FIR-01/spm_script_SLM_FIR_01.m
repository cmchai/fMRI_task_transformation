% Script to run Second level analysis(SLM_02) based on the result of FIR-01B for the Task Transformation Paradigm
...
jobfile_dir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_scripts/Matlab_GLM/univariate/FIR-01';
FLM_rootdir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/first_level/univariate/FIR-01B/results';
output_dir  = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/second_level/univariate/FIR-01B/results';
...
jobfile = {fullfile(jobfile_dir, 'spm_batchjob_SLM_FIR_01.m')};  % Attention: the format should be a cell array
