...
event_rootdir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/first_level/multivariate/GLM-02M/events';
output_rootdir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/first_level/multivariate/GLM-02M/results';
...
subjs = [3];     % subjects that will be run
...
for subj = subjs
    ...
    for ses = 1:n_ses
        ...
        for run = 1:n_run
            ...
            % select the corresponding image after preprocessing, but NOOOOOOO smoothing
