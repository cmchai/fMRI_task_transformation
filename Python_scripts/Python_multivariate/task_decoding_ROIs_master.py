...
ROIs = [np.array([128, 129, 130, 131, 132]),np.array([330, 331, 332, 333, 334])]
...
data_dir = '/Users/mengqiao/Documents/fMRI_task_transform/MRI_data/Task_transform/decoding/roi_approach'

result_df_name = 'decodeAcc_smthN_spmT_combined_Schaefer_rois.csv'
